...
public class GPSTrackingAdapter extends Service implements LocationListener{
    ...
    //
    public GPSTrackingAdapter(Context context){
    ...
    public void showSettingsAlert(){
        ...
        alertDialog.setMessage("Silahkan aktifkan GPS Anda !");
    ...
    public void stopUsingGPS(){
        if(locationManager != null){
            locationManager.removeUpdates(GPSTrackingAdapter.this);
        }
    }
}
